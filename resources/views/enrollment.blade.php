            ...
            <tbody>
                @foreach($enrollments as $enrollment )
                    <tr>
                        ...
                        <td>
                            <a href="{{route('updateEnrollments', $enrollment->id)}}">
